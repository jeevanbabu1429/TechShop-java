...
public class TechShopApp {
    public static void main(String[] args) {
        try (Connection connection = DBConnection.getConnection();
            ...
            CustomersDao customerDao = new CustomersDaoImpl(connection);
            ProductsDao productDao = new ProductsDaoImpl(connection);
            OrdersDao orderDao = new OrdersDaoImpl(connection);
            OrderDetailsDao orderDetailDao = new OrderDetailsDaoImpl(connection);
    ...
    // Customer Management
    private static void manageCustomers(Scanner scanner, CustomersDao customerDao) {
        boolean running = true;
        while (running) {
            System.out.println("\n--- Customer Management ---");
    ...
    private static void addCustomer(Scanner scanner, CustomersDao customerDao) {
    ...
    private static void viewCustomerById(Scanner scanner, CustomersDao customerDao) {
        System.out.print("Enter Customer ID: ");
        int id = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            Customers customer = customerDao.getUserById(id);
            if (customer != null) {
    ...
    private static void viewAllCustomers(CustomersDao customerDao) {
        try {
            List<Customers> customers = customerDao.getAllUsers();
            System.out.println("\nCustomer List:");
    ...
    private static void updateCustomer(Scanner scanner, CustomersDao customerDao) {
        System.out.print("Enter Customer ID to update: ");
        int updateId = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            Customers existingCustomer = customerDao.getUserById(updateId);
    ...
    private static void deleteCustomer(Scanner scanner, CustomersDao customerDao) {
    ...
    // Product Management
    private static void manageProducts(Scanner scanner, ProductsDao productDao) {
        boolean running = true;
        while (running) {
            System.out.println("\n--- Product Management ---");
    ...
    private static void addProduct(Scanner scanner, ProductsDao productDao) {
        ...
        Products newProduct = new Products(productID, productName, description, price, instock);
        try {
    ...
    private static void viewProductById(Scanner scanner, ProductsDao productDao) {
    ...
    private static void viewAllProducts(ProductsDao productDao) {
        try {
    ...
    private static void updateProduct(Scanner scanner, ProductsDao productDao) {
        System.out.print("Enter Product ID to update: ");
        int updateId = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            Products existingProduct = productDao.getProductById(updateId);
    ...
    private static void deleteProduct(Scanner scanner, ProductsDao productDao) {
    ...
    // Order Management
    private static void manageOrders(Scanner scanner, OrdersDao orderDao) {
        boolean running = true;
        while (running) {
            System.out.println("\n--- Order Management ---");
	...
	private static void addOrder(Scanner scanner, OrdersDao orderDao) {
        ...
        Orders newOrder = new Orders(orderID, customer, orderDate, totalAmount);
        try {
    ...
    private static void viewOrderById(Scanner scanner, OrdersDao orderDao) {
    ...
    private static void viewAllOrders(OrdersDao orderDao) {
        try {
    ...
    private static void updateOrder(Scanner scanner, OrdersDao orderDao) {
        System.out.print("Enter Order ID to update: ");
        int updateId = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            Orders existingOrder = orderDao.getOrderById(updateId);
    ...
    private static void deleteOrder(Scanner scanner, OrdersDao orderDao) {
 ...
 // Order Detail Management
    private static void manageOrderDetails(Scanner scanner, OrderDetailsDao orderDetailDao) {
        boolean running = true;
        while (running) {
            System.out.println("\n--- Order Detail Management ---");
    ...
    private static void addOrderDetail(Scanner scanner, OrderDetailsDao orderDetailDao) {
        ...
        Orders order = new Orders(orderId, null, new Date(), 0.0); // Placeholder for Order object
        Products product = new Products(productId, "", "", 0.0, true); // Placeholder for Product object
        OrderDetails newOrderDetail = new OrderDetails(orderDetailID, order, product, quantity);
    ...
    private static void viewOrderDetailById(Scanner scanner, OrderDetailsDao orderDetailDao) {
        System.out.print("Enter Order Detail ID: ");
        int id = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            OrderDetails orderDetail = orderDetailDao.getOrderDetailById(id);
            if (orderDetail != null) {
    ...
    private static void viewAllOrderDetails(OrderDetailsDao orderDetailDao) {
        try {
    ...
    private static void updateOrderDetail(Scanner scanner, OrderDetailsDao orderDetailDao) {
        System.out.print("Enter Order Detail ID to update: ");
        int updateId = scanner.nextInt();
        scanner.nextLine(); // Consume newline

        try {
            OrderDetails existingOrderDetail = orderDetailDao.getOrderDetailById(updateId);
    ...
    private static void deleteOrderDetail(Scanner scanner, OrderDetailsDao orderDetailDao) {
